...
if(tipo == 10):
	...
	matplotlib.pyplot.plot(iteracoes10, melhor10, label = "Execução com o melhor resultado")
	matplotlib.pyplot.scatter(iteracoes10, valoresmedia10, color='red')
	matplotlib.pyplot.scatter(iteracoes10, melhor10, color='red')
	...
	matplotlib.pyplot.ylim(-17.00,-10.00)
	matplotlib.pyplot.show()
else:
	matplotlib.pyplot.plot(iteracoes20, valoresmedia20, label ="Média 10 execuções")
	matplotlib.pyplot.plot(iteracoes20, melhor20, label="Execução com o melhor resultado")
	matplotlib.pyplot.scatter(iteracoes20, valoresmedia20, color='red')
	matplotlib.pyplot.scatter(iteracoes20, melhor20, color='red')
	matplotlib.pyplot.title("20 Iterações")
	matplotlib.pyplot.xlabel("Iterações")
	matplotlib.pyplot.ylabel("Média")
	matplotlib.pyplot.legend()
	matplotlib.pyplot.xlim(1,20)
	matplotlib.pyplot.ylim(-17,-11)
	matplotlib.pyplot.show()